...
但當使用者提供 **真實的 `s_website_form` 結構** (例如 `templates/base/base-form-contact.xml`) 時，AI 可以直接輸出完整表單結構，並維持原生欄位與屬性。
...
**結構範例 (`templates/base/base-form-contact.xml`)**：
```xml
...
**來源：** `templates/base/base-form-contact.xml`

...
This workflow defines the standard operating procedure (SOP) for generating Odoo 15 webpage code. It enforces strict adherence to documentation to ensure consistency and correctness.
...
1.  **MANDATORY**: You **MUST** read `.agent/skills/icb_page_generator/resources/dynamic_rules.md`.
...
1.  **Reference**: `.agent/skills/icb_page_generator/SKILL.md` (Core Design) & `.agent/skills/icb_page_generator/resources/layout_patterns.md`.
...
-   **YES**: You **MUST** read `.agent/skills/icb_page_generator/resources/button_styles.md`.
